...
function draw(e) {           //Drawing function
    ...
    context.lineTo(e.clientX, e.clientY - canvas.offsetTop);      //get x y coordinates 
    context.strokeStyle = color;                    //color of text
    context.lineWidth = lineSize;                   //line width
    context.stroke();
    context.beginPath();
    context.moveTo(e.clientX, e.clientY - canvas.offsetTop);      //end point
}
...
function changeColor(e) {
    ...
    if (!selectedMarker) {
        ...
        lineSize = 2;                                           //linesize updated                //preselected marker shifted on current
    }
